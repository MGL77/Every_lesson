<template>
  <div class="mywk__calendar">
    <div class="hui" @click="onClickLeft">
      <img src="../assets/img/ooooo.png" alt />
      <p>学习日历</p>
    </div>
    ...
    <div class="calendar">
      ...
      <div class="calendar__main">
        ...
        <div
          :class="`main__block ${item.content === selectedDate && 'main__block-today'}`"
